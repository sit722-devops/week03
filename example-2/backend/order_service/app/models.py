# week03/example-2/backend/order_service/app/models.py
...
class Order(Base):
    ...
    __tablename__ = "orders_week03_example_02"
...
class OrderItem(Base):
    ...
    __tablename__ = "order_items_week03_example_02"
    ...
    order_id = Column(
        Integer,
        ForeignKey("orders_week03_example_02.order_id"),
        nullable=False,
        index=True,
    )
